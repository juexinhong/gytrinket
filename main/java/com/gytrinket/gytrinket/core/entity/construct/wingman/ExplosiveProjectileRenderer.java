...
import com.gytrinket.gytrinket.core.entity.construct.drone.client.renderer.TrailType;
...
public class ExplosiveProjectileRenderer extends EntityRenderer<ExplosiveProjectile> {
    ...
    public ResourceLocation getTextureLocation(ExplosiveProjectile entity) {
        return ResourceLocation.withDefaultNamespace("textures/entity/explosive_projectile.png");
    }
}
