...
public class PlayerAttackLockManager {
    ...
    public static void cancelActiveModes(UUID playerUUID) {
        // 取消强袭叠层
        com.gytrinket.gytrinket.core.attack_mode.assault.AssaultManager.clearAssault(playerUUID);
        // 取消点射
        com.gytrinket.gytrinket.core.attack_mode.burst_fire.BurstFireManager.cancelBurstFire(playerUUID);
        // 取消充能攻击
        com.gytrinket.gytrinket.core.attack_mode.charged_attack.ChargedAttackManager.cancelCharging(playerUUID);
    }
