...
public class ShieldHudRenderer {
    ...
    private static final ResourceLocation SHIELD_HUD_TEXTURE = new ResourceLocation("gytrinket", "textures/gui/shield_hud.png");
    private static final ResourceLocation SHIELD_COOLDOWN_TEXTURE = new ResourceLocation("gytrinket", "textures/gui/shield_cooldown_hud.png");
