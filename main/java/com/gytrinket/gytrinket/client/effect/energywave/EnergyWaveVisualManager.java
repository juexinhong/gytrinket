package com.gytrinket.gytrinket.client.effect.energywave;

import com.gytrinket.gytrinket.client.compat.ShaderModCompat;
import com.gytrinket.gytrinket.core.entity.construct.swarm.client.EnergyWaveVolumetricRenderer;
...
public class EnergyWaveVisualManager {
    ...
    public static WaveTransform resolveTransform(WaveVisualData wave, float partialTick) {
        ...
        Vec3 fixedPos = new Vec3(wave.x, wave.y, wave.z);
        Vec3 fixedDir = new Vec3(wave.dirX, wave.dirY, wave.dirZ).normalize();
        return new WaveTransform(fixedPos, fixedDir);
    }
