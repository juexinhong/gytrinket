    ...
    public static void onRenderLevelLast(RenderLevelStageEvent event) {
        ...
        for (LightningRenderData data : lightningDataList) {
            ...
            for (ElectricDischargeManager.LightningSegment segment : segments) {
                ...
                bufferBuilder.addVertex(poseStack.last().pose(), (float) startLeft.x, (float) startLeft.y, (float) startLeft.z).setColor(colors[0], colors[1], colors[2], startAlpha);
                bufferBuilder.addVertex(poseStack.last().pose(), (float) startRight.x, (float) startRight.y, (float) startRight.z).setColor(colors[0], colors[1], colors[2], startAlpha);
                bufferBuilder.addVertex(poseStack.last().pose(), (float) endRight.x, (float) endRight.y, (float) endRight.z).setColor(colors[0], colors[1], colors[2], endAlpha);
                bufferBuilder.addVertex(poseStack.last().pose(), (float) endLeft.x, (float) endLeft.y, (float) endLeft.z).setColor(colors[0], colors[1], colors[2], endAlpha);
