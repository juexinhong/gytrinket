            ...
            if (entity instanceof DroneConstructEntity droneEntity && droneEntity.isAlive()) {
                ...
                if (hasAssaultModule && !droneEntity.hasEffectTag(DroneConstructEntity.DroneEffectTag.ASSAULT)) {
                    ...
                    if (droneEntity.getDroneConstruct() != null) {
                        droneEntity.getDroneConstruct().addEffect(new com.gy_mod.gy_trinket.core.entity.construct.drone.effect.AssaultEffect());
                    }
                    needRefresh = true;
                }
                ...
                if (hasDefenseModule && !droneEntity.hasEffectTag(DroneConstructEntity.DroneEffectTag.DEFENSE)) {
                    ...
                    if (droneEntity.getDroneConstruct() != null) {
                        droneEntity.getDroneConstruct().addEffect(new com.gy_mod.gy_trinket.core.entity.construct.drone.effect.DefenseEffect());
                    }
                    needRefresh = true;
                }
                ...
                if (!hasAssaultModule && droneEntity.hasEffectTag(DroneConstructEntity.DroneEffectTag.ASSAULT)) {
                    ...
                    if (droneEntity.getDroneConstruct() != null) {
                        droneEntity.getDroneConstruct().getEffects().removeIf(e -> e instanceof com.gy_mod.gy_trinket.core.entity.construct.drone.effect.AssaultEffect);
                    }
                    needRefresh = true;
                }
                ...
                if (!hasDefenseModule && droneEntity.hasEffectTag(DroneConstructEntity.DroneEffectTag.DEFENSE)) {
                    ...
                    if (droneEntity.getDroneConstruct() != null) {
                        droneEntity.getDroneConstruct().getEffects().removeIf(e -> e instanceof com.gy_mod.gy_trinket.core.entity.construct.drone.effect.DefenseEffect);
                    }
                    needRefresh = true;
                }
