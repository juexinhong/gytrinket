...
import com.gytrinket.gytrinket.blocks.LightPointCoreBlockEntity;
...
public class LightPointCoreBlockRenderer extends GeoBlockRenderer<LightPointCoreBlockEntity> {
    ...
    public void defaultRender(PoseStack poseStack, LightPointCoreBlockEntity animatable, MultiBufferSource bufferSource, RenderType renderType, VertexConsumer buffer, float yaw, float partialTick, int packedLight) {
        ...
        // 执行第二层渲染
        preRender(poseStack, animatable, model, bufferSource, secondBuffer, false, partialTick, packedLight, packedOverlay, renderColor);
        ...
        if (firePreRenderEvent(poseStack, model, bufferSource, partialTick, packedLight)) {
            ...
            actuallyRender(poseStack, animatable, model, secondRenderType, bufferSource, secondBuffer, false, partialTick, packedLight, packedOverlay, renderColor);
            ...
            postRender(poseStack, animatable, model, bufferSource, secondBuffer, false, partialTick, packedLight, packedOverlay, renderColor);
