package com.gytrinket.gytrinket.client.explosion;
 ...
 * 模拟爆炸贴图特效渲染器
 * <p>
 * 参考{@link com.gytrinket.gytrinket.client.shield.type.AuraRenderer 光环护盾}的渲染贴图方法：
...
public class SimulatedExplosionFXRenderer {
    ...
    private static final ResourceLocation EXPLOSION_TEXTURE = ResourceLocation.fromNamespaceAndPath(
    ...
    public static void onRenderLevelLast(RenderLevelStageEvent event) {
        ...
        for (ExplosionEffect effect : EFFECTS) {
            ...
            bufferBuilder.addVertex(matrix, px - halfSize, py, pz - halfSize).setColor(packedColor).setUv(0.0f, v0).setUv2(240, 240);
            bufferBuilder.addVertex(matrix, px - halfSize, py, pz + halfSize).setColor(packedColor).setUv(0.0f, v1).setUv2(240, 240);
            bufferBuilder.addVertex(matrix, px + halfSize, py, pz + halfSize).setColor(packedColor).setUv(1.0f, v1).setUv2(240, 240);
            bufferBuilder.addVertex(matrix, px + halfSize, py, pz - halfSize).setColor(packedColor).setUv(1.0f, v0).setUv2(240, 240);
        }
